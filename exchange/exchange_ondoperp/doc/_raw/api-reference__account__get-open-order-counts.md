...
> Returns open order counts per market/product for the authenticated account.



## OpenAPI

````yaml /api-reference/rest-spec.json get /v1/counts/orders
openapi: 3.0.3
info:
...
paths:
  /v1/counts/orders:
    get:
      ...
      description: >-
        Returns open order counts per market/product for the authenticated
        account.
