...
> Returns withdrawal limits for the authenticated account. For the withdrawal process and timing, see [Withdrawals](/withdrawals).



## OpenAPI

````yaml /api-reference/rest-spec.json get /v1/wallet/withdrawals/limit
openapi: 3.0.3
info:
...
paths:
  /v1/wallet/withdrawals/limit:
    get:
      ...
      description: >-
        Returns withdrawal limits for the authenticated account. For the
