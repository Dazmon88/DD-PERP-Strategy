...
> Remove a stop order. If no type is specified, removes both stop loss and take profit. For how stop orders work, see [Take profit and stop loss](/take-profit-and-stop-loss).



## OpenAPI

````yaml /api-reference/rest-spec.json delete /v1/perps/stop_order
openapi: 3.0.3
info:
...
paths:
  /v1/perps/stop_order:
    delete:
      ...
      description: >-
        Remove a stop order. If no type is specified, removes both stop loss and
        take profit. For how stop orders work, see [Take profit and stop
      ...
      parameters:
        ...
        - name: type
          in: query
          description: >
            The type of stop order to remove. Either "stopLoss" or "takeProfit".
            If not set, removes both stop loss and take profit orders.
          required: false
          schema:
            type: string
            enum:
