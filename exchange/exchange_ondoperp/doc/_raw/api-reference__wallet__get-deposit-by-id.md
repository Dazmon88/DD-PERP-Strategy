...
> Returns a single deposit by transaction ID. For supported assets and deposit steps, see [Funding your account](/funding-your-account).



## OpenAPI

````yaml /api-reference/rest-spec.json get /v1/wallet/deposits/{depositID}
openapi: 3.0.3
info:
...
paths:
  /v1/wallet/deposits/{depositID}:
    get:
      ...
      description: >-
        Returns a single deposit by transaction ID. For supported assets and
        deposit steps, see [Funding your account](/funding-your-account).
